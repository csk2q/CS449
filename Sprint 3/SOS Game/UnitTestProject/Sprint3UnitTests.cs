...
public void WinForRedPlayer_GeneralGame()
{
    ...
    // Step 2: Set the game mode to General using reflection
    var simpleGameRadioButton = typeof(MainWindow).GetField("SimpleGameRadioButton", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance)?.GetValue(window) as RadioButton;
    var generalGameRadioButton = typeof(MainWindow).GetField("GeneralGameRadioButton", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance)?.GetValue(window) as RadioButton;
    ...
    var redSChoice = typeof(MainWindow).GetField("RedSChoice", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance)?.GetValue(window) as RadioButton;
    var redOChoice = typeof(MainWindow).GetField("RedOChoice", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance)?.GetValue(window) as RadioButton;
    var blueSChoice = typeof(MainWindow).GetField("BlueSChoice", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance)?.GetValue(window) as RadioButton;
    var blueOChoice = typeof(MainWindow).GetField("BlueOChoice", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance)?.GetValue(window) as RadioButton;
    ...
    foreach (var button in new[] { buttons[1], buttons[0], buttons[4], buttons[2], buttons[3], buttons[7], buttons[5], buttons[6], buttons[8] })
    {
        button.RaiseEvent(new RoutedEventArgs(Button.ClickEvent));
    }
